      ...
      {step === 1 && (
        <div className={styles.step}>
          ...
          <div className={`${styles.grid} ${styles.cols2}`}>
            <OptionCard title="МУЖЧИНА" desc="Тестостерон высокий" selected={data.gender === 'мужчина'} onClick={() => set('gender', 'мужчина')} />
            <OptionCard title="ЖЕНЩИНА" desc="Сила без предела" selected={data.gender === 'женщина'} onClick={() => set('gender', 'женщина')} />
          </div>
